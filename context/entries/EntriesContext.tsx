...
interface ContextProps {
    ...
    completedTask: ({ taskId, entry, completed }: { taskId: string; entry: Entry; completed: boolean }) => void;
    deleteTask: (taskId: string, entry: Entry) => void;
    setIsEditingTask: (entry: Entry, task: Task) => void;
    updateTask: ({ taskId, entry, editedTask }: { taskId: string; entry: Entry; editedTask: string }) => void;
}
